---
title: "Autogenous - LDna chromosome 1"
...
pdf(file = here("output", "ldna", "pop", "chr1", "NEW_extractBranches.pdf"), width = 20, height = 12)
op <- par(mfcol=c(1,4))
...
pdf(file = here("output", "ldna", "pop", "chr1", "AUT_extractBranches.pdf"), width = 20, height = 12)
op <- par(mfcol=c(1,4))

---
title: "Autogenous - LDna chromosome 2"
...
pdf(file = here("output", "ldna", "pop", "chr2", "NEW_extractBranches.pdf"), width = 20, height = 12)
op <- par(mfcol=c(1,4))
...
Clean env and memory
```{r cleanup-memory-aut, eval=TRUE}
# Remove all objects from the environment
rm(list = ls())
...
pdf(file = here("output", "ldna", "pop", "chr2", "AUT_extractBranches.pdf"), width = 20, height = 12)
op <- par(mfcol=c(1,4))
